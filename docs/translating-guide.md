...
The browser extension supports new translations added in the form of new locales files added in `app/_locales`.
...
- Add the language to the [locales index](../app/_locales/index.json) `app/_locales/index.json`

That's it! When the wallet is loaded on a computer with that language set as the system language, they will see your translation instead of the default one.

## Testing

To automatically see if you are missing any phrases to translate, there is a script you can run (if you know how to use the command line). The script is:
...
To verify that your translation works in the app, you will need to build a local copy. You will need to change your browser language, your operating system language, and restart your browser.
